...
#Use L2
# and then separately used Dropout
...
def forward_propagation_with_dropout(X, parameters, keep_prob=0.5):
    ...
    A1 = A1 * D1  # Step 3: shutdown some neurons of A1
    ...
    A2 = A2 * D2  # Step 3: shutdown some neurons of A2
...
def backward_propagation_with_dropout(X, Y, cache, keep_prob):
    ...
    # YOUR CODE STARTS HERE
    dA2 = dA2 * D2  # Step 1: Apply mask D2 to shut down
    ...
    # YOUR CODE STARTS HERE
    dA1 = dA1 * D1  # Step 1: Apply mask D1 to shut down
    dA1 = dA1 / keep_prob  # Step 2: Scale the value of
