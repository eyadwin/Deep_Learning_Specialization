# your first neural network, which will have one hidden layer.
...
def backward_propagation(parameters, cache, X, Y):
    ...
    # axis = 1 means working along the row, summing the values on each row
    # keepdims=True, will make sure the summation result returned as 2D array (not 1D vector)
